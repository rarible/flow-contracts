...
# sell card
$TX $alice transactions/storefront/motogp-card/sell_flow.cdc 1 0.125
...
$TX $bob transactions/storefront/motogp-card/buy_flow.cdc 122 $ALICE

# sell card
$TX $alice transactions/storefront/motogp-card/sell_fusd.cdc 2 0.125
$SC transactions/storefront/scripts/read_storefront_ids.cdc $ALICE
$SC transactions/storefront/scripts/read_listing_details.cdc $ALICE 129
$TX $bob transactions/storefront/motogp-card/buy_fusd.cdc 129 $ALICE
...
# @param storefrontAddress
# @param saleId
#$SC scripts/storefront/read_details.cdc $ALICE 139
...
# @param cardId
# @param price
$TX $bob transactions/storefront/motogp-card/sell_flow.cdc 4 0.1

# buy card
# @param saleId
# @param storefrontAddress
$TX $eve transactions/storefront/motogp-card/buy_flow.cdc 137 $BOB


# read metadata on mainnet

# ids list
#flow -n mainnet scripts execute scripts/get_ids.cdc 0x6315e44b670d3d00

# metadata
#flow -n mainnet scripts execute scripts/borrow_nft.cdc 0x6315e44b670d3d00 10474
