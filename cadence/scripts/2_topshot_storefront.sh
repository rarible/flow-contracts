...
$TX $alice transactions/storefront/topshot/sell_moment_flow.cdc 12 1.0
...
$TX $bob transactions/storefront/topshot/buy_topshot_flow.cdc 1837 $ALICE

$TX $alice transactions/storefront/topshot/sell_moment_fusd.cdc 13 1.0
$SC transactions/storefront/scripts/read_storefront_ids.cdc $ALICE
$SC transactions/storefront/scripts/read_listing_details.cdc $ALICE 1839
$TX $bob transactions/storefront/topshot/buy_topshot_fusd.cdc 1839 $ALICE
