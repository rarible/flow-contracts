...
internal class AccountsTest {
    ...
    private val accounts = Accounts(
        api,
        listOf(Accounts.AccountDef("service",
            "0xf8d6e0586b0a20c7",
    ...
    fun readAccount() {
        ...
        assertEquals(api.getAccountAtLatestBlock(FlowAddress(address))!!.address.formatted, address)
    }
    ...
    @Test
    fun `is created`() {
        assertEquals(accounts.byName.map { it.value.address.formatted }.size, 4)
    }
